        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            ...
            <div>
              ...
              <img src="/images/bcar3.jpeg" alt="Heu" className="w-full h-64 object-cover rounded-lg" />
            </div>
            ...
            <div>
              ...
              <img src="/images/bcar1.jpeg" alt="Stroh" className="w-full h-64 object-cover rounded-lg" />
            </div>
